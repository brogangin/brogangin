...
const Page = () => {
  ...
  return (
    <form className="h-screen w-[500px] mx-auto pt-20 flex flex-col gap-2" onSubmit={handleSubmit}>
      ...
      <button className="border rounded-md p-2 bg-zinc-500 text-white hover:bg-zinc-400 ">Submit</button>
    </form>
  );
};
